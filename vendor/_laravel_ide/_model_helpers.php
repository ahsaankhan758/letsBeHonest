...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Follow>|Follow whereStatus($value)
     ...
     * @property string|null $open_to
     * @property string|null $gets_you_excited
     * @property string|null $see_yourself
     * @property string|null $brings_you_here
     * @property string|null $interested
     * @property mixed $vibe_id
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereVibeId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereInterested($value)
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereBringsYouHere($value)
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereSeeYourself($value)
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereGetsYouExcited($value)
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereOpenTo($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<UserProfile>|UserProfile wherePhotoUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UserProfile>|UserProfile whereIsProfile($value)
     ...
     * @property int $id
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder<Vibe>|Vibe whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vibe>|Vibe whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vibe>|Vibe whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vibe>|Vibe whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vibe>|Vibe whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vibe>|Vibe whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Vibe>|Vibe newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Vibe>|Vibe newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Vibe>|Vibe query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<Vibe>|Vibe timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Vibe extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
